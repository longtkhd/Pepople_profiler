    ...
    <div className="recruiter-job-details-container">
      ...
      >
        <Descriptions column={1} size="small">
          ...
          <Descriptions.Item label={<FormattedMessage {...messages.cvParsingUsed} />}>{data.parsing_used}</Descriptions.Item>
          <Descriptions.Item label={<FormattedMessage {...messages.candidateReports} />}>{data.report}</Descriptions.Item>
          <Descriptions.Item label={<FormattedMessage {...messages.assesmentUsage} />}>{data.assessment}</Descriptions.Item>
        </Descriptions>
      </FormInfoDetail>
    </div>
  );
