/*
 * CompanyInfoFormSetup Messages
 *
 * This contains all the text for the CompanyInfoFormSetup component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CompanyInfoFormSetup';
...
export default defineMessages({
  ...
  logoTips: {
    id: `${scope}.logoTips`,
    defaultMessage: 'Upload your logo {br} with a transparent background',
  }
});
