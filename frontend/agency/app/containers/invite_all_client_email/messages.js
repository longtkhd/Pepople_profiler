/*
 * InviteAllClientEmail Messages
 *
 * This contains all the text for the InviteAllClientEmail container.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.containers.InviteAllClientEmail';

export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'This is the InviteAllClientEmail container!',
  },
  title: {
    id: `${scope}.title`,
