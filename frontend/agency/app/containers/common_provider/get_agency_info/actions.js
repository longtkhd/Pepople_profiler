...
export function clearAgencyInfoAction() {
  return {
    type: CLEAR_AGENCY_INFO
  }
}

export function clearCompanyLogoAction() {
  return {
    type: CLEAR_COMPANY_LOGO
  }
}

export function clearCompanyBackgroundAction() {
  return {
    type: CLEAR_COMPANY_BACKGROUND
  }
}
