...
export class S3ManagerService {
    ...
    // Call S3 to create the bucket
    async uploadFile(bucketName: string, file: Buffer, key: string): Promise<S3.Location | undefined> {
    ...
    // Call S3 to create the bucket
    async listObjects(bucketName: string): Promise<S3.ListObjectsOutput | undefined> {
        const bucketParams = {
            Bucket: bucketName
        }
        return new Promise((resolve, reject) => {
