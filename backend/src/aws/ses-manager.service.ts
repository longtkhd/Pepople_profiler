...
export class SESManagerService {
    ...
    public async sendEmailWithAttachments(from: string | Mail.Address, subject, html, toAddresses, attachments, replyTo?: string | Mail.Address
    ) {
        ...
        this._transporter.sendMail(mailOptions).then((info: SentMessageInfo) => {
